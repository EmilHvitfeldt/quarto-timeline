...
Works with any single character or number. The dot automatically enlarges to `2rem` when `data-dot` is set. Override `--tl-dot-size` on the event or timeline if you need a different size.
